...
public class LoginActivity extends AppCompatActivity {
    ...
    private Button btn_login,btn_register;//登录注册按钮
    ...
    private void init() {
        ...
        et_psw=findViewById(R.id.passwordText);
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                auth.signInWithEmailAndPassword(userName,
                        psw).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    @Override
                ...
                if(TextUtils.isEmpty(userName)){
                    Toast.makeText(LoginActivity.this, "Input Email", Toast.LENGTH_LONG).show();
                    return;
                    ...
                    Toast.makeText(LoginActivity.this, "Email and password not consistent", Toast.LENGTH_LONG).show();
                    return;
                }else{
                    Toast.makeText(LoginActivity.this, "Email not existed", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
